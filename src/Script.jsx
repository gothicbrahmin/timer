  ...
  return (
    <div class="wrapper">
      ...
      <div class="row justify-content-center">
        <button class="btn btn-light" id="start_stop" onClick={props.startStop}>
          {props.timerOn ? "Pause" : "Play"}
          <i class="fa fa-play" aria-hidden="true" />
          <i class="fa fa-pause" aria-hidden="true" />
        </button>
        <button class="btn btn-light ml-1" id="reset" onClick={props.reset}>
          reset
